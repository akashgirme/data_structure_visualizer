...
const ArrayAnimation = () => {
  ...
  return (
    <Grid container rowSpacing='2' display='flex' flexDirection='column' className="array-animation-container">
        ...
        <Grid item lg={9} display='flex' justifyContent='center' alignItems='center'>
          <Box display='flex' flexDirection='column' className="array-controls">
            <Box display='flex' alignItems='center'>
              <Box display='flex' mr='0.8rem' alignItems='center'><TextField varient="outlined" label="Enter Element"
                  type="number"
                  value={inputNumber}
                  size='small'
                  ...
                  ref={inputRef}
              /></Box>
              <Box><Button variant="contained" onClick={addSquare}>Add Element</Button></Box>
              <Box mx='2rem'><Button variant="contained" onClick={removeSquare} disabled={squares.length === 0}>
                Remove Last Element
              </Button></Box>
            </Box>

            <Box mt='1rem' display='flex' alignItems='center'>
                <Box><TextField label="Enter Index of Element"
                  type="number"
                  value={indexToRemove}
                  size='small'
                  onChange={(e) => setIndexToRemove(e.target.value)}
                /></Box>
                <Box ml='0.8rem'><Button variant="contained" onClick={removeSpecificSquare}>Remove Element</Button></Box>
            </Box>
      ...
      <Grid container spacing={2} display='flex' justifyContent='center'>
          <Grid item lg={12} display='flex' justifyContent='center'>
            <div className="array-display" ref={arrayRef}>
              <div className="array-border-top" style={{width: `${arraySize * 77}px`}}/>
              ...
              <div className='array-border-bottom' style={{width: `${arraySize * 77}px`}}/>
            </div>
          </Grid>
      </Grid>
    </Grid>

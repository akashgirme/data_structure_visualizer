      ...
      >
        ...
        >
          <Box display="flex" justifyContent="between" alignItems="center">
            ...
            >
              <label>
                <Typography variant="subtitle1">Stack Size:</Typography>
              </label>
              <Slider
                sx={{ width: "300px" }}
                min={5}
              ...
              />
              <label>
                <Typography variant="subtitle1">{stackSize}</Typography>
              </label>
            </Box>
            <Box display="flex" alignItems="center">
              ...
              />
              <Box ml="0.5rem">
                <Button variant="contained" onClick={pushToStack}>
                  Push
                </Button>
              </Box>
              <Box ml="1.5rem">
        ...
        >
          ...
          >
            ...
            <Box className="d-flex stack-info justify-content-around align-items-center">
              ...
              <Typography variant="h6" p="1">
                <strong>Index of Top:</strong>{" "}
                {stack.length > 0 ? stack.length - 1 : "N/A"}
              </Typography>
            </Box>
          </Box>
        </Grid>
